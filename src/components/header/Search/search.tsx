...
const Search: FunctionComponent<SearchProps> = ({ className }) => {
  return (
    <div className={className}>
      <div
        className={`flex items-center bg-grey py-3 px-4 rounded-full lg:w-[370px] xl:w-[577px] ${className}`}
      >
        <svg
          width="24"
          height="24"
        ...
        <input
          ...
          className="ms-3 border-none bg-transparent text-black focus-visible:outline-none placeholder:text-opacity-40 w-full"
        />
      </div>
    </div>
  );
